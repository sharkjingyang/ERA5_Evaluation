...
| 数据集 | 内容 | 磁盘大小 |
|--------|------|---------|
| HRES 预报 | 2020-01-01 00:00 和 12:00 两个初始化时刻，各 40 个 lead time | ~46 MB |
| ERA5 观测 | 2020-01-01 ~ 2020-01-12（覆盖预报最长 10 天有效时刻） | ~27 MB |
| ERA5 气候态 | 1990-2019 全年（用于 ACC 计算，无法按日期切片） | ~607 MB |
...
| 数据集 | 内容 | 磁盘大小 |
|--------|------|---------|
| HRES 预报 | 2020-01-01 00:00 和 12:00 两个初始化时刻，各 40 个 lead time | ~600 MB |
| ERA5 观测 | 2020-01-01 ~ 2020-01-12（覆盖预报最长 10 天有效时刻） | ~351 MB |
| ERA5 气候态 | 1990-2019，dayofyear 1-30（chunk 宽度为 30 天，`slice(1,12)` 会加载完整第一个 chunk） | ~334 MB |
